...
<script src="<?php echo base_url();?>asset/js/ui-bootstrap.min.js"></script>
<script src="<?php echo base_url();?>asset/js//ui-bootstrap-tpls.min.js"></script>
...
<script type="text/javascript" language="javascript" src="<?php echo base_url();?>asset/js/dataTables.bootstrap.js"></script>
 ...
 <script type="text/javascript" language="javascript" src="<?php echo base_url();?>asset/js/jszip.min.js"></script>
<script type="text/javascript" language="javascript" src="<?php echo base_url();?>asset/js/pdfmake.min.js"></script>
<script src="<?php echo base_url();?>asset/js/vfs_fonts.js" type="text/javascript"></script>
<script src="<?php echo base_url();?>asset/js/buttons.html5.min.js" type="text/javascript"></script>
<script src="<?php echo base_url();?>asset/js/buttons.print.min.js" type="text/javascript"></script>

<script type="text/javascript" src="<?php echo base_url();?>asset/js/TableTools.min.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>asset/js/sum().js"></script>
...
<script src="<?php echo base_url();?>asset/vendors/validator/validator.js"></script>
...
<script>
  $(document).ready(function() {
   $('#harga1').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax": "<?php echo site_url('ajax/harga'); ?>",
"PaginationType": "full_numbers",
"sDom": 'T<"clear">lfrtip',
"oTableTools": {
"sSwfPath": "<?php echo base_url();?>media/swf/copy_csv_xls_pdf.swf"
},
